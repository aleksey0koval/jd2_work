...
public class ProductTest extends BaseTest {
    ...
    public void read() {
        ...
        List<ProductPrice> prices = products.stream()
                .filter(product -> "2c931081773acfd101773acfd4180002".equals(product.getProductId()))
    ...
    public void delete() {
        ...
        assertEquals(
                0,
                session.createQuery("from Product p").list().size()
        );
    }
    ...
    public void queryProductPrice() {
        ...
        final List priceValue = factory.openSession().createCriteria(ProductPrice.class)
